...
export function AccountLinkClient() {
  ...
  return (
    <Link
      ...
      className="hidden h-9 items-center gap-2 border border-white/10 bg-white/[0.04] px-3 font-mono text-[10px] uppercase tracking-[0.2em] text-white/70 transition-colors hover:bg-white/10 md:inline-flex"
