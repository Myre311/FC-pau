  ...
  if (intent.status !== 'succeeded') {
    return (
      <div className="container-fc py-24 text-center">
        <p className="text-xs text-pau-yellow uppercase tracking-wider">Paiement en attente</p>
  ...
  return (
    <div className="container-fc py-16 md:py-24">
      ...
      <div className="max-w-2xl">
        <p className="text-xs text-pau-yellow uppercase tracking-wider">Paiement confirmé</p>
...
function FallbackMissing() {
  return (
    <div className="container-fc py-24 text-center">
      <p className="text-xs text-pau-yellow uppercase tracking-wider">Référence manquante</p>
      <h1 className="mt-4 font-display text-5xl uppercase leading-crush tracking-tightest md:text-6xl">
