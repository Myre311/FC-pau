    ...
    <article>
      ...
      <section className="container-fc pt-16 pb-12 md:pt-24 md:pb-20">
        ...
        <h1 className="mt-6 text-[14vw] md:text-[10vw] lg:text-[140px]">
          PÔLE <span className="text-jaune">MASCULIN</span>
        </h1>
        ...
        <div className="grid gap-10 md:grid-cols-2 md:gap-16">
          <div>
            ...
            <div className="mt-6 space-y-4 font-sans text-base leading-relaxed text-blanc/75 md:text-lg">
              ...
              <p>
                <strong className="text-blanc">Hébergement</strong> — Chambres
                doubles ou individuelles, accès WiFi.
              </p>
              <p>
                <strong className="text-blanc">Restauration</strong> —
          ...
          <div>
            ...
            <div className="mt-6 space-y-4 font-sans text-base leading-relaxed text-blanc/75 md:text-lg">
              ...
              <p>
                <strong className="text-blanc">Collège</strong> — Cours le
                matin, entraînements l'après-midi.
              </p>
              <p>
                <strong className="text-blanc">Lycée</strong> — Sections
                sportives. Bac général, technologique ou professionnel.
              </p>
              <p>
                <strong className="text-blanc">Études</strong> — Salle de
...
function StaffCard({ title, items }) {
  return (
    <div>
      <h3 className="font-display text-2xl uppercase leading-tight tracking-tight text-jaune md:text-3xl">
        {title}
      </h3>
      <ul className="mt-4 space-y-2 font-sans text-base text-blanc/75">
        {items.map((item, idx) => (
