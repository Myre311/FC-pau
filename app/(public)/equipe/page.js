...
function StaffMember({ name, role, image }) {
  return (
    <article className="border border-white/10 bg-pau-primary p-5 transition-all hover:border-white/20">
      <div className="flex items-center gap-4">
        <div className="relative h-16 w-16 flex-shrink-0 overflow-hidden rounded-full bg-pau-night">
          {image ? (
            <Image
              src={image}
              alt={name}
