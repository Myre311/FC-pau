...
export default async function HomePage() {
  ...
  // Récupérer les images Instagram via oEmbed
  const instagramPosts = [
    'https://www.instagram.com/reel/DVO30xjCCP9/',
    'https://www.instagram.com/reel/DXtkscXMch2/',
    'https://www.instagram.com/p/DXoYs2eCMKb/',
    'https://www.instagram.com/p/DXkRbWJDn9d/',
    'https://www.instagram.com/p/DXjublojM5a/',
    'https://www.instagram.com/p/DXht_SpCAA6/',
    'https://www.instagram.com/p/DXhf7AnCKwn/',
    'https://www.instagram.com/p/DXhantZiJGd/'
  ];

  const instagramData = await Promise.all(
    instagramPosts.map(async (url) => {
      try {
        const response = await fetch(`https://graph.instagram.com/oembed?url=${url}`);
        ...
        return { url, thumbnail: null, title: 'Instagram post' };
      }
    })
  ).catch(() => instagramPosts.map(url => ({ url, thumbnail: null, title: 'Instagram post' })));
