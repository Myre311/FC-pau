  ...
  return (
    <article className="container-fc grid gap-10 py-12 md:grid-cols-2 md:gap-16 md:py-20">
      ...
      <div className="flex flex-col">
        ...
        <p className="mt-3 font-mono text-xs uppercase tracking-[0.2em] text-jaune">
          {formatPrice(product.basePrice)}
        </p>

        {product.description && (
          <p className="mt-6 max-w-prose font-sans text-base leading-relaxed text-blanc/70">
            {product.description}
          </p>
        )}
        ...
        {product.customizable && (
          <Link
            ...
            className="mt-6 inline-flex items-center gap-3 self-start border-b border-jaune/40 py-1 font-mono text-[11px] uppercase tracking-[0.2em] text-jaune transition-colors hover:border-jaune"
          >
        ...
        <dl className="mt-10 grid grid-cols-3 gap-4 border-t border-blanc/10 pt-6 font-mono text-[10px] uppercase tracking-[0.2em]">
          <div>
            <dt className="text-blanc/40">Stock total</dt>
            <dd className="mt-1 text-blanc">{totalStock}</dd>
          </div>
          <div>
            <dt className="text-blanc/40">Variantes</dt>
            <dd className="mt-1 text-blanc">{product.variants.length}</dd>
          </div>
          <div>
            <dt className="text-blanc/40">Saison</dt>
            <dd className="mt-1 text-blanc">25-26</dd>
          </div>
        </dl>
      </div>
    </article>
