...
export default async function BilletteriePage() {
  ...
  return (
    <article>
      ...
      {/* Tarifs */}
      <section className="border-y border-pau-night/10 bg-white pb-22 pt-18 md:pb-28 md:pt-24">
        <div className="container-pau">
          <div className="mb-14">
      ...
      {/* Cashless */}
      <section className="bg-white pb-18 pt-16 md:pb-24 md:pt-22">
        <div className="container-pau">
      ...
      {/* Infos pratiques */}
      <section className="border-y border-pau-night/10 bg-white pb-20 pt-18 md:pb-26 md:pt-24">
        <div className="container-pau">
          <div className="mb-14">
          ...
          <div className="grid gap-14 md:grid-cols-2">
            <div className="border-2 border-pau-night/10 bg-white/5 p-8">
              <h3 className="mb-6 font-display text-2xl font-bold uppercase text-pau-yellow">
                Accès au stade
              </h3>
              <div className="space-y-4 font-sans text-base text-pau-night/80">
                <p>
                  <strong className="text-pau-night">Adresse</strong><br />
                  Nouste Camp, 8 Boulevard de l'Aviation, 64320 Bizanos
                </p>
                <p>
                  <strong className="text-pau-night">Parking</strong><br />
                  Gratuit autour du stade (places limitées)
                </p>
                <p>
                  <strong className="text-pau-night">Bus</strong><br />
                  Ligne 4, arrêt "Nouste Camp"
                </p>
                <p>
                  <strong className="text-pau-night">Ouverture portes</strong><br />
            ...
            <div className="border-2 border-pau-night/10 bg-white/5 p-8">
              ...
              <ul className="space-y-3 font-sans text-base text-pau-night/80">
                <li className="flex items-start gap-3">
      ...
      <section className="bg-white pb-20 pt-16 md:pb-26 md:pt-22">
        <div className="container-pau">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mx-auto mt-7 max-w-xl font-sans text-lg text-pau-night/70">
