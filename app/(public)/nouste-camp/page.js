...
export default function NousteCampPage() {
  return (
    <article>
      ...
      <SectionLight className="border-t border-pau-night/10">
        <div className="grid gap-10 md:grid-cols-[1fr_2fr] md:gap-16">
          <h2 className="font-display text-5xl uppercase leading-crush tracking-tightest text-pau-night md:text-6xl">
            Les tribunes
          </h2>
      ...
      <SectionLight className="border-t border-pau-night/10">
        <div className="grid gap-10 md:grid-cols-2 md:gap-16">
          <div>
            <h2 className="font-display text-4xl uppercase leading-crush tracking-tightest text-pau-night md:text-5xl">
              Acces
            </h2>
            <ul className="mt-6 space-y-4 font-sans text-base text-pau-night/75">
...
function Stat({ label, value }) {
  return (
    <div>
      <dt className="font-mono text-[10px] uppercase tracking-[0.2em] text-pau-night/40">
        {label}
      </dt>
      <dd className="mt-2 font-display text-4xl uppercase leading-crush tracking-tightest text-pau-night md:text-5xl">
        {value}
      </dd>
    </div>
  );
...
function Tribune({ name, capacity, note }) {
  return (
    <li className="flex flex-col justify-between gap-2 border-t border-pau-night/10 pt-5 md:flex-row md:items-center">
      <div>
        <p className="font-display text-2xl uppercase leading-crush tracking-tightest text-pau-night">
          {name}
        </p>
      ...
      <p className="font-sans text-sm text-pau-night/60 md:max-w-xs md:text-right">
        {note}
      </p>
    </li>
  );
